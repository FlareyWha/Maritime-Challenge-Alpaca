...
$query = "select sUsername, bShowBirthday, dBirthday, iCurrentTitleID, sBiography, iLevel, iXP, iDepartment, iGuildID, iCountry, iTotalRightshipRollars, iTotalTokens, iTotalEventCurrency, fPlayerXPos, fPlayerYPos, fPlayerZPos from tb_account where UID=?";
$stmt = $conn->prepare($query);
$stmt->bind_param("i", $uid);
$stmt->execute();
$stmt->bind_result($sUsername, $bShowBirthday, $dBirthday, $iCurrentTitleID, $sBiography, $iLevel, $iXP, $iDepartment, $iGuildID, $iCountry, $iTotalRightshipRollars, $iTotalTokens, $iTotalEventCurrency, $fPlayerXPos, $fPlayerYPos, $fPlayerZPos);
